...
\begin{figure}
   \centering
    %\includegraphics[width=5in]{internet_health.jpeg}%name of the image
      \stackunder{\includegraphics[width=0.8\textwidth]{internet_health.jpeg}}%
             {\scriptsize%
...
%insert a figure
    \begin{figure}[H]
      \centering
      \stackunder{\includegraphics[width=0.6\textwidth]{Infor_survey.png}}%
            {\scriptsize%
...
%insert a figure
    \begin{figure}[H]
      \centering
      \stackunder{\includegraphics[width=0.6\textwidth]{use_health_data.png}}%
            {\scriptsize%
...
%insert a figure
    \begin{figure}[H]
      \centering
      \stackunder{\includegraphics[width=0.6\textwidth]{Refuse_use.png}}%
            {\scriptsize%
...
%insert a figure
    \begin{figure}[H]
      \centering
      \stackunder{\includegraphics[width=0.6\textwidth]{Magage_data.png}}%
            {\scriptsize%
